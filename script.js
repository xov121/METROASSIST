...
function generateDraft() {
  ...
  // Constructing the lanes description
  ...
  // Generate instructions based on selected situations
...
function generateAssistance() {
  ...
  const kilometer = document.getElementById('kilometerAssistance').value;

  const direction = document.getElementById('directionAssistance').value;



  const assistanceText = `Unidad ${unit}\nColor ${color}\nMarca ${brand}\n${service} en el km ${kilometer} en dirección ${direction}.`;



  document.getElementById('assistanceGenerated').innerText = assistanceText;
